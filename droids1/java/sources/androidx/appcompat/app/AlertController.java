        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    AnonymousClass2 r12 = new CursorAdapter(this.mContext, cursor, false) {
                ...
                if (cursor2 != null) {
                    SimpleCursorAdapter simpleCursorAdapter = new SimpleCursorAdapter(this.mContext, layout, cursor2, new String[]{this.mLabelColumn}, new int[]{16908308});
