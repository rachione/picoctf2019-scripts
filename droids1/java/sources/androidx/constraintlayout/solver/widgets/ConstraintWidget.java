...
public class ConstraintWidget {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintAnchor$Type = new int[Type.values().length];
            try {
                $SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintAnchor$Type[Type.LEFT.ordinal()] = 1;
        ...
        if (type == Type.CENTER) {
            if (type2 == Type.CENTER) {
                ...
                if (type2 == Type.LEFT || type2 == Type.RIGHT) {
                    ...
                    int i4 = creator;
                    connect(Type.TOP, constraintWidget4, type3, 0, strength5, i4);
                    connect(Type.BOTTOM, constraintWidget4, type3, 0, strength5, i4);
                    getAnchor(Type.CENTER).connect(target.getAnchor(constraintTo), 0, i);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:105:0x01db  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:143:0x029e  */
    ...
    public void addToSolver(LinearSystem system) {
        ...
        if (f <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && matchConstraintDefaultWidth2 == 3 && matchConstraintDefaultHeight2 == 3) {
                ...
                boolean z = verticalDimensionFixed;
                ...
                if (useRatio) {
                    ...
                    if (this.mVerticalResolution == 2) {
                        boolean wrapContent3 = this.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
                        if (useRatio) {
                    ...
                    if (!isBeginConnected && isEndConnected) {
                        ...
                        if (variableSize2) {
                            ...
                            if (matchConstraintDefault5 == 0) {
                                ...
                                applyBoundsCheck = applyBoundsCheck4;
