...
public class ConstraintLayout extends ViewGroup {
            ...
            if (widget2 == null) {
                ...
                if (layoutParams2.helped) {
                    ...
                    try {
                        ...
                        setDesignInformation(z ? 1 : 0, IdAsString2, Integer.valueOf(child3.getId()));
                ...
                if (layoutParams2.isGuideline) {
                    ...
                    if (layoutParams2.circleConstraint != -1) {
                        ...
                        int i9 = resolvedLeftToLeft2;
                        helperCount = helperCount3;
                        View view2 = child3;
                        float f = resolvedHorizontalBias;
                        int i10 = resolvedRightToRight2;
                        ...
                        if (resolvedLeftToLeft2 != -1) {
                            ...
                            if (target2 != null) {
                                ...
                                View view3 = child3;
                                layoutParams = layoutParams2;
                                widget2.immediateConnect(type, constraintWidget, type3, resolvedRightToLeft3, resolveGoneLeftMargin2);
                            } else {
                            ...
                            if (resolveGoneRightMargin != -1) {
                                ConstraintWidget target3 = getTargetWidget(resolveGoneRightMargin);
                                if (target3 != null) {
                                    widget2.immediateConnect(Type.LEFT, target3, Type.RIGHT, layoutParams.leftMargin, resolveGoneLeftMargin2);
                                }
                            }
                        }
                        if (helperCount2 != -1) {
                            ConstraintWidget target4 = getTargetWidget(helperCount2);
                            if (target4 != null) {
                                widget2.immediateConnect(Type.RIGHT, target4, Type.LEFT, layoutParams.rightMargin, resolvedLeftToLeft);
                            }
                        } else if (resolvedRightToRight != -1) {
                            ConstraintWidget target5 = getTargetWidget(resolvedRightToRight);
                            if (target5 != null) {
                                widget2.immediateConnect(Type.RIGHT, target5, Type.RIGHT, layoutParams.rightMargin, resolvedLeftToLeft);
                            }
                        }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (sizeDependentWidgetsCount > 0) {
            ...
            int minWidth3 = i9;
            while (i7 < sizeDependentWidgetsCount) {
                int paddingTop2 = paddingTop;
                ConstraintWidget widget = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i7);
            ...
            while (true) {
                ...
                ConstraintWidget widget2 = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i14);
