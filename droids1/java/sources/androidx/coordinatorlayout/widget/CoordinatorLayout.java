    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i2 < childCount2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                heightUsed4 = Math.max(heightUsed2, heightPadding + child.getMeasuredHeight() + lp.topMargin + lp.bottomMargin);
                childState4 = View.combineMeasuredStates(childState2, child.getMeasuredState());
        ...
        int i6 = heightMode2;
        int i7 = childState4;
        int childState5 = heightUsed4;
        int widthUsed5 = childState3;
        int widthUsed6 = i7;
        setMeasuredDimension(View.resolveSizeAndState(widthUsed5, widthMeasureSpec, -16777216 & widthUsed6), View.resolveSizeAndState(childState5, heightMeasureSpec, widthUsed6 << 16));
    }
