        ...
        if (fragment2 != null) {
            ...
            if (containerId != 0) {
                ...
                if (command != 1) {
                    ...
                    wasAdded = false;
                    FragmentContainerTransition containerTransition42 = (FragmentContainerTransition) sparseArray.get(containerId);
                    if (setLastIn) {
                    }
                    if (!isReorderedTransaction) {
                    }
                ...
                setFirstOut = false;
                wasAdded = true;
                FragmentContainerTransition containerTransition422 = (FragmentContainerTransition) sparseArray.get(containerId);
                if (setLastIn) {
                }
                if (!isReorderedTransaction) {
                }
